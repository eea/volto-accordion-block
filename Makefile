...
VLT_ENABLED?=
VLT_PACKAGE_VERSION?=7.8.2
VLT_BM3_COMPAT_VERSION?=1.0.0-alpha.1
VLT_SLIDER_BLOCK_VERSION?=6.4.1
DOCKER_COMPOSE=PLONE_VERSION=${PLONE_VERSION} VOLTO_VERSION=${VOLTO_VERSION} ADDON_NAME=${ADDON_NAME} ADDON_PATH=${ADDON_PATH} VLT_ENABLED=${VLT_ENABLED} VLT_PACKAGE_VERSION=${VLT_PACKAGE_VERSION} VLT_BM3_COMPAT_VERSION=${VLT_BM3_COMPAT_VERSION} VLT_SLIDER_BLOCK_VERSION=${VLT_SLIDER_BLOCK_VERSION} docker compose
